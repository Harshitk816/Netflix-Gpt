...
const Header = () => {
  ...
  return (
    <div className='fixed px-8 py-2 w-screen bg-gradient-to-b from-black z-50 flex flex-col md:flex-row lg:flex-row justify-between'>
        ...
        {user && (<div className='flex justify-between p-2'>
          ...
          <button onClick={handleGptSearchClick} className='py-0 px-3 md:px-4 lg:px-4 my-4 md:my-4 lg:my-4 mx-[-20px] md:m-4 lg:m-4 rounded-md drop-shadow-lg bg-purple-500 text-white text-sm md:text-md lg:text-md font-semibold md:font-bold lg:font-bold'>{!gptSearch? "Search": "Home"}</button>
